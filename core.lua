...
local font_face    = [[Interface\AddOns\recTimers\media\Oceania-Medium.ttf]]
local font_size    = 9
local font_outline = ""
local texture      = [[Interface\AddOns\recTimers\media\normtexa]]
local edge_file    = [[Interface\AddOns\recTimers\media\glowtex]]
